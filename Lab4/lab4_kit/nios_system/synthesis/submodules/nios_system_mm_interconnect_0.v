...
module nios_system_mm_interconnect_0 (
		...
		output wire [31:0] lda_avalon_interface_s1_address,                     //                       lda_avalon_interface_s1.address
		output wire        lda_avalon_interface_s1_write,                       //                                              .write
		output wire        lda_avalon_interface_s1_read,                        //                                              .read
		input  wire [31:0] lda_avalon_interface_s1_readdata,                    //                                              .readdata
		output wire [31:0] lda_avalon_interface_s1_writedata,                   //                                              .writedata
		input  wire        lda_avalon_interface_s1_waitrequest,                 //                                              .waitrequest
	...
	wire   [33:0] nios2_processor_data_master_translator_avalon_universal_master_0_address;              // nios2_processor_data_master_translator:uav_address -> nios2_processor_data_master_agent:av_address
	...
	wire  [109:0] rsp_mux_src_data;                                                                      // rsp_mux:src_data -> nios2_processor_data_master_agent:rp_data
	...
	wire   [33:0] nios2_processor_instruction_master_translator_avalon_universal_master_0_address;       // nios2_processor_instruction_master_translator:uav_address -> nios2_processor_instruction_master_agent:av_address
	...
	wire   [33:0] nios2_processor_jtag_debug_module_agent_m0_address;                                    // nios2_processor_jtag_debug_module_agent:m0_address -> nios2_processor_jtag_debug_module_translator:uav_address
	...
	wire  [110:0] nios2_processor_jtag_debug_module_agent_rf_source_data;                                // nios2_processor_jtag_debug_module_agent:rf_source_data -> nios2_processor_jtag_debug_module_agent_rsp_fifo:in_data
	...
	wire  [110:0] nios2_processor_jtag_debug_module_agent_rsp_fifo_out_data;                             // nios2_processor_jtag_debug_module_agent_rsp_fifo:out_data -> nios2_processor_jtag_debug_module_agent:rf_sink_data
	...
	wire  [109:0] cmd_mux_src_data;                                                                      // cmd_mux:src_data -> nios2_processor_jtag_debug_module_agent:cp_data
	...
	wire   [33:0] onchip_memory_s1_agent_m0_address;                                                     // onchip_memory_s1_agent:m0_address -> onchip_memory_s1_translator:uav_address
	...
	wire  [109:0] cmd_mux_001_src_data;                                                                  // cmd_mux_001:src_data -> onchip_memory_s1_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                                 // onchip_memory_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [4:0] cmd_mux_001_src_channel;                                                               // cmd_mux_001:src_channel -> onchip_memory_s1_agent:cp_channel
	...
	wire   [33:0] switches_s1_agent_m0_address;                                                          // switches_s1_agent:m0_address -> switches_s1_translator:uav_address
	...
	wire   [33:0] leds_s1_agent_m0_address;                                                              // LEDs_s1_agent:m0_address -> LEDs_s1_translator:uav_address
	...
	wire   [31:0] lda_avalon_interface_s1_agent_m0_readdata;                                             // lda_avalon_interface_s1_translator:uav_readdata -> lda_avalon_interface_s1_agent:m0_readdata
	wire          lda_avalon_interface_s1_agent_m0_waitrequest;                                          // lda_avalon_interface_s1_translator:uav_waitrequest -> lda_avalon_interface_s1_agent:m0_waitrequest
	wire          lda_avalon_interface_s1_agent_m0_debugaccess;                                          // lda_avalon_interface_s1_agent:m0_debugaccess -> lda_avalon_interface_s1_translator:uav_debugaccess
	wire   [33:0] lda_avalon_interface_s1_agent_m0_address;                                              // lda_avalon_interface_s1_agent:m0_address -> lda_avalon_interface_s1_translator:uav_address
	wire    [3:0] lda_avalon_interface_s1_agent_m0_byteenable;                                           // lda_avalon_interface_s1_agent:m0_byteenable -> lda_avalon_interface_s1_translator:uav_byteenable
	wire          lda_avalon_interface_s1_agent_m0_read;                                                 // lda_avalon_interface_s1_agent:m0_read -> lda_avalon_interface_s1_translator:uav_read
	wire          lda_avalon_interface_s1_agent_m0_readdatavalid;                                        // lda_avalon_interface_s1_translator:uav_readdatavalid -> lda_avalon_interface_s1_agent:m0_readdatavalid
	wire          lda_avalon_interface_s1_agent_m0_lock;                                                 // lda_avalon_interface_s1_agent:m0_lock -> lda_avalon_interface_s1_translator:uav_lock
	wire   [31:0] lda_avalon_interface_s1_agent_m0_writedata;                                            // lda_avalon_interface_s1_agent:m0_writedata -> lda_avalon_interface_s1_translator:uav_writedata
	wire          lda_avalon_interface_s1_agent_m0_write;                                                // lda_avalon_interface_s1_agent:m0_write -> lda_avalon_interface_s1_translator:uav_write
	wire    [2:0] lda_avalon_interface_s1_agent_m0_burstcount;                                           // lda_avalon_interface_s1_agent:m0_burstcount -> lda_avalon_interface_s1_translator:uav_burstcount
	wire          lda_avalon_interface_s1_agent_rf_source_valid;                                         // lda_avalon_interface_s1_agent:rf_source_valid -> lda_avalon_interface_s1_agent_rsp_fifo:in_valid
	wire  [110:0] lda_avalon_interface_s1_agent_rf_source_data;                                          // lda_avalon_interface_s1_agent:rf_source_data -> lda_avalon_interface_s1_agent_rsp_fifo:in_data
	wire          lda_avalon_interface_s1_agent_rf_source_ready;                                         // lda_avalon_interface_s1_agent_rsp_fifo:in_ready -> lda_avalon_interface_s1_agent:rf_source_ready
	wire          lda_avalon_interface_s1_agent_rf_source_startofpacket;                                 // lda_avalon_interface_s1_agent:rf_source_startofpacket -> lda_avalon_interface_s1_agent_rsp_fifo:in_startofpacket
	wire          lda_avalon_interface_s1_agent_rf_source_endofpacket;                                   // lda_avalon_interface_s1_agent:rf_source_endofpacket -> lda_avalon_interface_s1_agent_rsp_fifo:in_endofpacket
	wire          lda_avalon_interface_s1_agent_rsp_fifo_out_valid;                                      // lda_avalon_interface_s1_agent_rsp_fifo:out_valid -> lda_avalon_interface_s1_agent:rf_sink_valid
	wire  [110:0] lda_avalon_interface_s1_agent_rsp_fifo_out_data;                                       // lda_avalon_interface_s1_agent_rsp_fifo:out_data -> lda_avalon_interface_s1_agent:rf_sink_data
	wire          lda_avalon_interface_s1_agent_rsp_fifo_out_ready;                                      // lda_avalon_interface_s1_agent:rf_sink_ready -> lda_avalon_interface_s1_agent_rsp_fifo:out_ready
	wire          lda_avalon_interface_s1_agent_rsp_fifo_out_startofpacket;                              // lda_avalon_interface_s1_agent_rsp_fifo:out_startofpacket -> lda_avalon_interface_s1_agent:rf_sink_startofpacket
	wire          lda_avalon_interface_s1_agent_rsp_fifo_out_endofpacket;                                // lda_avalon_interface_s1_agent_rsp_fifo:out_endofpacket -> lda_avalon_interface_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_004_src_valid;                                                                 // cmd_mux_004:src_valid -> lda_avalon_interface_s1_agent:cp_valid
	wire  [109:0] cmd_mux_004_src_data;                                                                  // cmd_mux_004:src_data -> lda_avalon_interface_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                                 // lda_avalon_interface_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [4:0] cmd_mux_004_src_channel;                                                               // cmd_mux_004:src_channel -> lda_avalon_interface_s1_agent:cp_channel
	wire          cmd_mux_004_src_startofpacket;                                                         // cmd_mux_004:src_startofpacket -> lda_avalon_interface_s1_agent:cp_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                           // cmd_mux_004:src_endofpacket -> lda_avalon_interface_s1_agent:cp_endofpacket
	wire          nios2_processor_data_master_agent_cp_valid;                                            // nios2_processor_data_master_agent:cp_valid -> router:sink_valid
	wire  [109:0] nios2_processor_data_master_agent_cp_data;                                             // nios2_processor_data_master_agent:cp_data -> router:sink_data
	...
	wire  [109:0] nios2_processor_instruction_master_agent_cp_data;                                      // nios2_processor_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [109:0] nios2_processor_jtag_debug_module_agent_rp_data;                                       // nios2_processor_jtag_debug_module_agent:rp_data -> router_002:sink_data
	...
	wire          lda_avalon_interface_s1_agent_rp_valid;                                                // lda_avalon_interface_s1_agent:rp_valid -> router_006:sink_valid
	wire  [109:0] lda_avalon_interface_s1_agent_rp_data;                                                 // lda_avalon_interface_s1_agent:rp_data -> router_006:sink_data
	wire          lda_avalon_interface_s1_agent_rp_ready;                                                // router_006:sink_ready -> lda_avalon_interface_s1_agent:rp_ready
	wire          lda_avalon_interface_s1_agent_rp_startofpacket;                                        // lda_avalon_interface_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          lda_avalon_interface_s1_agent_rp_endofpacket;                                          // lda_avalon_interface_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [109:0] router_001_src_data;                                                                   // router_001:src_data -> nios2_processor_instruction_master_limiter:cmd_sink_data
	...
	wire  [109:0] nios2_processor_instruction_master_limiter_cmd_src_data;                               // nios2_processor_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [109:0] rsp_mux_001_src_data;                                                                  // rsp_mux_001:src_data -> nios2_processor_instruction_master_limiter:rsp_sink_data
	...
	wire  [109:0] nios2_processor_instruction_master_limiter_rsp_src_data;                               // nios2_processor_instruction_master_limiter:rsp_src_data -> nios2_processor_instruction_master_agent:rp_data
	...
	wire          lda_avalon_interface_s1_agent_rdata_fifo_src_valid;                                    // lda_avalon_interface_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] lda_avalon_interface_s1_agent_rdata_fifo_src_data;                                     // lda_avalon_interface_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          lda_avalon_interface_s1_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_004:in_0_ready -> lda_avalon_interface_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                     // avalon_st_adapter_004:out_0_valid -> lda_avalon_interface_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                      // avalon_st_adapter_004:out_0_data -> lda_avalon_interface_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                     // lda_avalon_interface_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                     // avalon_st_adapter_004:out_0_error -> lda_avalon_interface_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) lda_avalon_interface_s1_translator (
		.clk                    (clk_0_clk_clk),                                       //                      clk.clk
		.reset                  (nios2_processor_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (lda_avalon_interface_s1_agent_m0_address),            // avalon_universal_slave_0.address
		.uav_burstcount         (lda_avalon_interface_s1_agent_m0_burstcount),         //                         .burstcount
		.uav_read               (lda_avalon_interface_s1_agent_m0_read),               //                         .read
		.uav_write              (lda_avalon_interface_s1_agent_m0_write),              //                         .write
		.uav_waitrequest        (lda_avalon_interface_s1_agent_m0_waitrequest),        //                         .waitrequest
		.uav_readdatavalid      (lda_avalon_interface_s1_agent_m0_readdatavalid),      //                         .readdatavalid
		.uav_byteenable         (lda_avalon_interface_s1_agent_m0_byteenable),         //                         .byteenable
		.uav_readdata           (lda_avalon_interface_s1_agent_m0_readdata),           //                         .readdata
		.uav_writedata          (lda_avalon_interface_s1_agent_m0_writedata),          //                         .writedata
		.uav_lock               (lda_avalon_interface_s1_agent_m0_lock),               //                         .lock
		.uav_debugaccess        (lda_avalon_interface_s1_agent_m0_debugaccess),        //                         .debugaccess
		.av_address             (lda_avalon_interface_s1_address),                     //      avalon_anti_slave_0.address
		.av_write               (lda_avalon_interface_s1_write),                       //                         .write
		.av_read                (lda_avalon_interface_s1_read),                        //                         .read
		.av_readdata            (lda_avalon_interface_s1_readdata),                    //                         .readdata
		.av_writedata           (lda_avalon_interface_s1_writedata),                   //                         .writedata
		.av_waitrequest         (lda_avalon_interface_s1_waitrequest),                 //                         .waitrequest
		.av_begintransfer       (),                                                    //              (terminated)
		.av_beginbursttransfer  (),                                                    //              (terminated)
		.av_burstcount          (),                                                    //              (terminated)
		.av_byteenable          (),                                                    //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) lda_avalon_interface_s1_agent (
		.clk                     (clk_0_clk_clk),                                            //             clk.clk
		.reset                   (nios2_processor_reset_n_reset_bridge_in_reset_reset),      //       clk_reset.reset
		.m0_address              (lda_avalon_interface_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (lda_avalon_interface_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (lda_avalon_interface_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (lda_avalon_interface_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (lda_avalon_interface_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (lda_avalon_interface_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (lda_avalon_interface_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (lda_avalon_interface_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (lda_avalon_interface_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (lda_avalon_interface_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (lda_avalon_interface_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (lda_avalon_interface_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (lda_avalon_interface_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (lda_avalon_interface_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (lda_avalon_interface_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (lda_avalon_interface_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (lda_avalon_interface_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (lda_avalon_interface_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (lda_avalon_interface_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (lda_avalon_interface_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (lda_avalon_interface_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (lda_avalon_interface_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (lda_avalon_interface_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (lda_avalon_interface_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (lda_avalon_interface_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (lda_avalon_interface_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),                        // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),                        //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),                         //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),                        //                .error
		.rdata_fifo_src_ready    (lda_avalon_interface_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (lda_avalon_interface_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (lda_avalon_interface_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                    //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                      //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) lda_avalon_interface_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                            //       clk.clk
		.reset             (nios2_processor_reset_n_reset_bridge_in_reset_reset),      // clk_reset.reset
		.in_data           (lda_avalon_interface_s1_agent_rf_source_data),             //        in.data
		.in_valid          (lda_avalon_interface_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (lda_avalon_interface_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (lda_avalon_interface_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (lda_avalon_interface_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (lda_avalon_interface_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (lda_avalon_interface_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (lda_avalon_interface_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (lda_avalon_interface_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (lda_avalon_interface_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                    // (terminated)
		.csr_read          (1'b0),                                                     // (terminated)
		.csr_write         (1'b0),                                                     // (terminated)
		.csr_readdata      (),                                                         // (terminated)
	...
	nios_system_mm_interconnect_0_router_004 router_006 (
		.sink_ready         (lda_avalon_interface_s1_agent_rp_ready),              //      sink.ready
		.sink_valid         (lda_avalon_interface_s1_agent_rp_valid),              //          .valid
		.sink_data          (lda_avalon_interface_s1_agent_rp_data),               //          .data
		.sink_startofpacket (lda_avalon_interface_s1_agent_rp_startofpacket),      //          .startofpacket
		.sink_endofpacket   (lda_avalon_interface_s1_agent_rp_endofpacket),        //          .endofpacket
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                       // in_clk_0.clk
		.in_rst_0_reset (nios2_processor_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (lda_avalon_interface_s1_agent_rdata_fifo_src_data),   //     in_0.data
		.in_0_valid     (lda_avalon_interface_s1_agent_rdata_fifo_src_valid),  //         .valid
		.in_0_ready     (lda_avalon_interface_s1_agent_rdata_fifo_src_ready),  //         .ready
